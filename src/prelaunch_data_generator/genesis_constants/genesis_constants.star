def new_prefunded_account(address, private_key, alias="_"):
    return struct(address=address, private_key=private_key, alias=alias)
...
PRE_FUNDED_ACCOUNTS = [
    ...
    # Account index 11: Deployment account for K2 and PON contracts
    new_prefunded_account(
